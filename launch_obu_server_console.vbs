    ...
    command = "cmd /k title OBU_Server_Console & color 0A & echo Connecting to OBU_Server_Console... & ssh -t -o StrictHostKeyChecking=no root@192.168.0.53 ""/tmp/obu_alert_server"""
    ...
    For i = 1 To 20  ' Increased retries to 10 seconds total
        If WshShell.AppActivate("OBU_Server_Console") Then
            success = True
            Exit For
        End If
        WScript.Sleep 500
